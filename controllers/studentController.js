...
const addStudent = async (req, res) => {
  const { studentID, studentName, studentLastname, gender, tel, phone, school, district, stayID } = req.body;
  try {
    await studentModel.addStudent(studentID, studentName, studentLastname, gender, tel, phone, school, district, stayID);
